...
COMPRESS_STORAGE = 'sstorages.backends.s3boto.S3BotoStorage'
AWS_ACCESS_KEY_ID = os.environ['AWS_AKI']
AWS_SECRET_ACCESS_KEY = os.environ['AWS_SAK']
AWS_STORAGE_BUCKET_NAME = 'collegenotes'
